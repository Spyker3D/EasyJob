Приложение использует HeadHunter API для поиска вакансий (включая их детальное описание) в России, Казахстане, Беларуси и в прочих странах, входящих в СНГ. Приложение разрабатывалось командой из 5 человек, список разработчиков указан на экране информации о команде разработчиков.
